...
data = {
    "intents": [{
        ...
        "tag": "greeting",
        "patterns": ["Aslam O balalaika", "Hi there", "How are you", "Is anyone there?", "Hey", "Hi"],
        ...
        "responses": ["I am a general purpose chatbot. My capabilities are : \n 1. I can chat with you. Try asking me "
                      "for jokes or riddles! \n 2. Ask me the date and time \n 3. I can google search for you. Use "
                      "format google: your query \n 4. I can get the present weather for any city. Use format "
                      "weather: city name \n 5. I can get you the top 10 trending news in India. Use keywords 'Latest "
                      "News' \n 6. I can get you the top 10 trending songs globally. Type 'songs' \n 7. I can set a "
                      "timer for you. Enter 'set a timer: minutes to timer' \n 8. I can get the present Covid stats "
                      "for any country. Use 'covid 19: world' or 'covid 19: country name' \n For suggestions to help "
                      "me improve, send an email to ted.thedlbot.suggestions@gmail.com . Thank you!! "],

    }, {
        "tag": "location,واقع ,جگہ",
        "patterns": [" اپ کا ادارہ کہاں ہے", " شبلی سکول کہاں  ہے", " where is shibli school situated",
                     " where is shibli school"],
        ...
        "patterns": [
            ...
            "Dhai machine ki chutney", "چھٹیاں کدو ہون گیاں؟", "کیا آپ بتا سکدے ہو کہ چھٹیاں کدو ہون گیاں؟",
            "میرے سکول کی گرمیوں کدو ہون گیاں؟", "گرمیوں کی چھٹیاں کدوں شروع ہون گیاں اور کتھے دناں لئی ہون گیاں؟",
            "کیا آپ کو یہ معلوم ہے کہ چھٹیاں کدو ہون گیاں اور کتھے دناں تک ہون گیاں؟",
            "میرے سکول کی گرمیوں کدو ہون گیاں اور کتھے دناں لئی ہون گیاں؟",
            "چھٹیاں کدوں شروع ہون گیاں اور کتھے دناں تک رہیاں گیاں؟",
            "کیا آپ بتا سکدے ہو کہ چھٹیاں کدو ہوں گیاں اور کتھے دناں لئی ہون گیاں؟",
            "میرے سکول کی گرمیوں کدو ہون گیاں اور کتھے دناں لئی ہون گیاں؟",
            "گرمیوں کی چھٹیاں کدوں شروع ہون گیاں اور کتھے دناں تک ہون گیاں"
            ...
            "میرے سکول کی گرمیوں کی چھٹیاں کب ہونگی اور کتنے دنوں کے لئے ہونگی؟",
            "گرمیوں کی چھٹیاں کب شروع ہونگی اور کتنے دنوں کے لئے ہونگی؟",
            " گرمیاں دیاں چھٹیاں کدوں ہون گیاں ؟", "when summer holidays will starts", "summer vacations",
            " گرمیاں دیاں چھٹیاں", "  ٹائیاں مہینیاں دیاں چھٹیاں", " garmiyon diyan chhutiyan kiddon hon gian"],
        "responses": [" چھٹیوں کا اغاز یکم جون سے ہوگا", " chutney June 1,2023 se hon gi"],

    }, {
        "tag": " پرنسپل کا نام",
        "patterns": ["  ہیڈ ماسٹر کا نام", " پرنسپل کا نام", " who is the principal of shiblee School", " principal",
                     " name of principal", " ہیڈ ماسٹر کون یے", " شیبلی سکول کا ہیڈ ماسٹر"],
        "responses": [" MUHAMMAD WAQAR AHMAD Sahib"]
    }, {
        "tag": " کھلے گا، سکول کا ٹائم",
        "patterns": [" What is schedule of classes", "time table", " period start", "prayer time",
                     " کلاسز کب شروع ہوتی ہیں", "  pahla period kab Shuru Hota Hai", " پہلا پیریڈ کب شروع ہوتا ہے",
                     " چھٹی کب ہوتی ہے"],
        "responses": ["prayer time:7:15\n first period 8:00\n end classes 2:00PM",
                      " پریئر ساڑھے سات  شروع ہوتی ہے\nکلاس اٹھ بجے شروع ہوتی ہے \n  چھٹی دو بجے ہوتی ہے"]
    }, {
        "tag": "fees",
        "patterns": ["What is fees of 6th class", " چھٹی کلاس کی فیس کتنی ہے", " ساتویں کلاس کی فیس کتنی ہے",
                     " اٹھویں کلاس کی فیس کتنی ہے", " نویں کلاس کی فیس کتنی ہے", " دسویں کلاس کی فیس کتنی ہے"],
        "responses": [
            "6th class: Rs. 1100\n7th class: Rs. 1200\n8th class: Rs. 1300\n9th class: Rs. 1400\n10th class: Rs.1500"]
    }, {
        "tag": " colour  رنگ ",
        "patterns": [" لیڑیاں دا رنگ", "یونی فارم کا رنگ  ", " شرٹ کا کلر ", " پینٹ کا رنگ ", "ٹائی کا کلر ",
                     " شوز کا کلر "],
        ...
        "tag": "exam ,terms",
        "patterns": ["exam", "term", " سالانہ امتحان کب ہوں گے", "  فسٹ ٹرم کب ہوگی", " سیکنڈ ٹرم کب ہوگی",
                     " تھرڈ ٹرم کب ہوگی"],
        "responses": [
            "فسٹ ٹرم 10 مئی سے شروع ہوگی\nسیکنڈ ٹرم یکم اگست سے شروع ہو گی\nتھرڈ ٹرم یکم دسمبر سے شروع ہوگی\nسالانہ "
            "امتحانات 10 فروری کو ہوں گے\nنوٹ! سالانہ امتحان کے نتائج کا اعلان\nفروری کی 28 تاریخ کو کیا جائے گا"]
    }, {
        "tag": "fees card",
        "patterns": [" فیس کارڈ کتنے  روپے کا ہے", " رزلٹ کارڈ کتنے کا ہے", " رزلٹ کارڈ کی قیمت کیا ہے",
                     " price of result card"],
        "responses": [" فیس کارڈ کی قیمت 70 روپے ہے\n رزلٹ کارڈ کی قیمت 50 روپے ہے"]
    }, {
        "tag": "contact",
        "patterns": ["your phone number", " your contact number", " School cell number", " شبلی سکول کا فون نمبر",
                     "شبلی اسکول کا رابطہ نمبر"],
        "responses": ["03467711243 \n ubaid243@gmail.com"]
    }, {
        "tag": "میڈیم",
        "patterns": [" kya aapka School English medium hai", " shibli is English medium or Urdu medium",
                     "who motivates you"],
        ...
        "patterns": [
            ...
            "I want to call to sarwar sahib", "I want to talk to sarwar sahib", "I want to chat to sarwar sahib"
                                                                                "کیا سرور صاحب موجود ہیں۔ میں ان سے "
                                                                                "بات کرنا چاہتا ہوں۔",
        ...
        "patterns": [
            ...
            "I want to know the timing of the school tour to tree.",
            "Please inform me about the date of the school excursion to tree.",
            ...
            "جی موجود ہیں بات کیجئ   n/ ٹھنڈے موسم کی چھٹیوں میں"
        ],
        "responses": [
